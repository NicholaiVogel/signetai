...
Tag range: `v0.214.44..v0.214.45`.

### Bug Fixes

- **daemon**: refresh event-loop contract baseline
- **daemon**: harden native memory provider gating
- **daemon**: repair event-loop audit site tokens
- **daemon**: bound native source embedding outages

## [0.214.44] - 2026-08-31

Release summary: 3 bug fixes.
Tag range: `v0.214.43..v0.214.44`.

### Bug Fixes

- **cli**: abort OAuth prompts on callback completion
- **cli**: pass abort signal to pi-ai OAuth
- **inference**: update pi-ai model registry

## [0.214.43] - 2026-08-31

Release summary: 5 bug fixes and 1 docs update.
Tag range: `v0.214.42..v0.214.43`.

### Bug Fixes

- **daemon**: preserve fresh workspace startup
- **core**: fail closed on malformed workspace pointers
- **daemon**: create startup state after workspace preflight
- **cli**: preflight workspace before daemon probes
- **daemon**: fail closed when configured workspace disappears

### Docs

- document fail-closed workspace startup

## [0.214.42] - 2026-08-31

Release summary: 4 bug fixes.
Tag range: `v0.214.41..v0.214.42`.

### Bug Fixes

- **daemon**: preserve graph context safety
- **daemon**: keep graph recall reads on db owner
- **daemon**: bound owner traversal deadlines
- **daemon**: route memory recall traversal through db owner

## [0.214.41] - 2026-08-31

Release summary: 2 bug fixes.
Tag range: `v0.214.40..v0.214.41`.

### Bug Fixes

- **cli**: pause setup spinner while prompting
- **inference**: cover compiled CLI OAuth setup

## [0.214.40] - 2026-08-31

Release summary: 1 bug fix.
Tag range: `v0.214.39..v0.214.40`.

### Bug Fixes

- **sdk**: preserve non-task type exports

## [0.214.39] - 2026-08-31

Release summary: 1 bug fix and 3 refactors.
Tag range: `v0.214.38..v0.214.39`.

### Bug Fixes

- **daemon**: make owner lease retries idempotent

### Refactoring

- **daemon**: route wave 7 workers through db owner
- **daemon**: route knowledge graph reads through db owner
- **daemon**: stabilize DB attribution IDs

## [0.214.38] - 2026-08-31

Release summary: 4 bug fixes and 3 refactors.
Tag range: `v0.214.37..v0.214.38`.

### Bug Fixes

- **dreaming**: record backlog mirror on the owner-maintenance branch (#1759 re-verdict finding)
- **daemon**: isolate Dreaming token worker requests
- **daemon**: bound exact Dreaming token accounting
- **memorybench**: enforce provider SDK contracts

### Refactoring

- **memorybench**: isolate server composition root
- **daemon**: separate widget generation from probe persistence
- **daemon**: isolate Dreaming backlog cache
...
Release summary: 5 bug fixes and 1 refactor.
Tag range: `v0.214.34..v0.214.35`.

### Bug Fixes

- **audit**: resolve wave-5 + foundation merge — realign contract inventory to 899/219/217/383
- **daemon**: make lifecycle close recovery robust
- **daemon**: reopen accessor lifecycle between closes
- **daemon**: close DB lifecycle registrations atomically
- **daemon**: require DB owner for vacuum work

### Refactoring

- **daemon**: isolate DB foundation lifecycle
...
Release summary: 1 bug fix.
Tag range: `v0.214.32..v0.214.33`.

### Bug Fixes

- **stability**: repair compiled first-use path
...
Release summary: 4 bug fixes.
Tag range: `v0.214.30..v0.214.31`.

### Bug Fixes

- **ci**: track detached boot descendants
- **ci**: close boot-wedge gate review gaps
- **daemon**: route pipeline reads through owner
- **ci**: harden boot wedge measurements
...
Release summary: 2 bug fixes.
Tag range: `v0.214.27..v0.214.28`.

### Bug Fixes

- **audit**: distinguish async DB execution homes
- **audit**: classify database execution homes

## [0.214.27] - 2026-08-29

Release summary: 1 bug fix.
Tag range: `v0.214.26..v0.214.27`.

### Bug Fixes

- **daemon**: bound scheduled Dreaming backlog probes
...
Release summary: 1 bug fix.
Tag range: `v0.214.22..v0.214.23`.

### Bug Fixes

- **daemon**: route predictive context DB scans through owner

## [0.214.22] - 2026-08-28

Release summary: 2 bug fixes.
Tag range: `v0.214.21..v0.214.22`.

### Bug Fixes

- **daemon**: restore scoped focal query fallback
- **daemon**: owner-route W5 contention paths

## [0.214.21] - 2026-08-28

Release summary: 1 bug fix.
Tag range: `v0.214.20..v0.214.21`.

### Bug Fixes

- **daemon**: owner-route structural feature reads
...
Release summary: 2 bug fixes.
Tag range: `v0.214.9..v0.214.10`.

### Bug Fixes

- **daemon**: rebase site tokens after vacuum space-guard edit
- **daemon**: allow unknown migration backup space
...
Release summary: 4 bug fixes.
Tag range: `v0.212.1..v0.212.2`.

### Bug Fixes

- **daemon**: checkpoint integrity maintenance (#1691)
- **daemon**: bound integrity maintenance retries
- **daemon**: harden incremental integrity maintenance
- **daemon**: checkpoint integrity maintenance

## [0.212.1] - 2026-08-19

Release summary: 2 bug fixes.
Tag range: `v0.212.0..v0.212.1`.

### Bug Fixes

- **ci**: validate live PR body in readiness checklist (#1692)
- **ci**: read PR checklist body live

## [0.212.0] - 2026-08-19

Release summary: 3 features and 1 bug fix.
Tag range: `v0.211.20..v0.212.0`.

### Features

- **daemon**: prioritize owner foreground workloads (#1690)
- **daemon**: prioritize owner foreground workloads
- **daemon**: prioritize owner foreground workloads

### Bug Fixes

- **daemon**: close owner lane review findings

## [0.211.20] - 2026-08-19

Release summary: 3 bug fixes.
Tag range: `v0.211.19..v0.211.20`.

### Bug Fixes

- **daemon**: unblock DB-owner startup handshake (#1686)
- **daemon**: address db owner startup review findings
- **daemon**: unblock db owner startup handshake

## [0.211.19] - 2026-08-19

Release summary: 2 bug fixes.
Tag range: `v0.211.18..v0.211.19`.

### Bug Fixes

- bound status and diagnostics projections (#1689)
- **daemon**: bound status and diagnostics projections

## [0.211.18] - 2026-08-19

Release summary: 5 bug fixes.
Tag range: `v0.211.17..v0.211.18`.

### Bug Fixes

- **tests**: close phase d pollers deterministically
- **tests**: harden phase d acceptance harness
- **tests**: hard self-destruct timer in acceptance runner
- **tests**: seed real embedding vectors; fail loudly on shape drift
- **tests**: resolve core migrations via relative path
...
Release summary: 2 bug fixes.
Tag range: `v0.211.15..v0.211.16`.

### Bug Fixes

- **daemon**: degrade instead of die when sqlite-vec fails to load (#1682)
- **daemon**: degrade when sqlite-vec load fails

## [0.211.15] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.14..v0.211.15`.

### Bug Fixes

- **daemon**: bound /health DB read admission to 500ms
...
Release summary: 5 bug fixes.
Tag range: `v0.211.12..v0.211.13`.

### Bug Fixes

- **daemon**: preserve async embedding usage read
- **daemon**: wire chunked vacuum reclaim into maintenance
- **daemon**: chunk incremental vacuum reclaim
- **daemon**: move vacuum conversion to owner
- **daemon**: isolate dashboard status reads

## [0.211.12] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.11..v0.211.12`.

### Bug Fixes

- **cli**: support daemonless update recovery

## [0.211.11] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.10..v0.211.11`.

### Bug Fixes

- **daemon**: isolate database initialization from event loop

## [0.211.10] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.9..v0.211.10`.

### Bug Fixes

- **dreaming**: publish head and manifest atomically

## [0.211.9] - 2026-08-18

Release summary: 2 bug fixes.
Tag range: `v0.211.8..v0.211.9`.

### Bug Fixes

- **daemon**: preserve unknown backup space metrics
- **daemon**: handle degenerate statfs block sizes

## [0.211.8] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.7..v0.211.8`.

### Bug Fixes

- **cli**: resolve macOS Homebrew outside PATH

## [0.211.7] - 2026-08-18

Release summary: 5 bug fixes.
Tag range: `v0.211.6..v0.211.7`.

### Bug Fixes

- **embedding**: gate reindex before scanning
- **embedding**: honor open circuit in reindex
- **embedding**: wire provider breaker notices and probes
- **daemon**: wire embedding breaker failure paths
- **daemon**: share embedding provider circuit breaker

## [0.211.6] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.5..v0.211.6`.

### Bug Fixes

- **daemon**: isolate embedding usage database work

## [0.211.5] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.4..v0.211.5`.

### Bug Fixes

- **daemon**: persist embedding provider failure retry

## [0.211.4] - 2026-08-18

Release summary: 1 bug fix.
Tag range: `v0.211.3..v0.211.4`.

### Bug Fixes

- **synthesis**: retire remaining completion callers
...
Release summary: 1 bug fix.
Tag range: `v0.211.1..v0.211.2`.

### Bug Fixes

- **cli**: honor Hermes profile targets
...
Release summary: 1 feature and 2 bug fixes.
Tag range: `v0.209.1..v0.210.0`.

### Features

- **agent**: enforce memory policy mutations

### Bug Fixes

- **daemon**: validate agent policy route fields
- **agent**: harden policy route validation

## [0.209.1] - 2026-08-17

Release summary: 4 bug fixes.
Tag range: `v0.209.0..v0.209.1`.

### Bug Fixes

- **daemon**: repair retired synthesis hook regressions
- **daemon**: restore Dreaming memory publication
- **daemon**: close synthesis publication side doors
- **memory**: retire idle-gap head publication
...
Release summary: 1 bug fix.
Tag range: `v0.208.1..v0.208.2`.

### Bug Fixes

- **release**: preserve detached resume checkout

## [0.208.1] - 2026-08-17

Release summary: 3 bug fixes.
Tag range: `v0.208.0..v0.208.1`.

### Bug Fixes

- **ci**: bound release resume tag length
- **ci**: safely resume releases from exact tag
- **ci**: make nightly release resumable

## [0.208.0] - 2026-08-17

Release summary: 2 features and 6 bug fixes.
Tag range: `v0.207.2..v0.208.0`.

### Features

- **hermes**: add explicit target resolution
- **memory**: wire Dreaming head capability and manifest

### Bug Fixes

- **hermes**: contain uninstall profile mutations
- **hermes**: close explicit target registration gaps
- **hermes**: harden explicit target writes
- **hermes**: enforce explicit target ownership
- **daemon**: route memory head curation through async writer
- **dreaming**: make head curation atomic
...
Release summary: 7 bug fixes.
Tag range: `v0.207.0..v0.207.1`.

### Bug Fixes

- **native**: fence valid addon versions during sweep
- **native**: use hash-keyed addon materialization
- **native**: preserve live addon during publish retries
- **native**: publish embedded addons safely on Windows
- **native**: repair Windows keyring asset and materialization parity
- **native**: enforce compiled keyring asset contracts
- **secrets**: require keyring native addon by absolute path in compiled builds
...
Release summary: 5 bug fixes.
Tag range: `v0.206.7..v0.206.8`.

### Bug Fixes

- **daemon**: report import cleanup failures
- **daemon**: restore generation-safe import cleanup
- **daemon**: migrate import extraction write
- **daemon**: migrate source purge to async owner
- **daemon**: route import writes through owner

## [0.206.7] - 2026-08-17

Release summary: 11 bug fixes.
Tag range: `v0.206.6..v0.206.7`.

### Bug Fixes

- **daemon**: honor tombstone contract in lifecycle cleanup
- **daemon**: scope lifecycle cleanup generations
- **daemon**: CAS dashboard import cleanup
- **sources**: CAS source deletion generations
- **sources**: retain legacy deletion barriers
- **sources**: make legacy tombstones unknown
- **sources**: use durable lifecycle generations
- **daemon**: gate source tombstones by generation
- **daemon**: retain deletion tombstones
- **daemon**: hide tombstoned sources
- **daemon**: defer tombstone cleanup

## [0.206.6] - 2026-08-17

Release summary: 2 bug fixes.
Tag range: `v0.206.5..v0.206.6`.

### Bug Fixes

- **daemon**: await synthesis purge
- **daemon**: await async source-owner tests
...
Release summary: 2 bug fixes.
Tag range: `v0.206.3..v0.206.4`.

### Bug Fixes

- **daemon**: fail open Discord tails
- **daemon**: clean Discord gateway failures
...
Release summary: 8 bug fixes.
Tag range: `v0.206.1..v0.206.2`.

### Bug Fixes

- **daemon**: make source deletion resumable
- **sources**: atomize lifecycle telemetry
- **daemon**: route sources through db owner
- **daemon**: satisfy source routing audit
- **daemon**: finish source owner routing
- **daemon**: route native sources through owner
- **daemon**: expose source graph owner operations
- **daemon**: route snapshot import through owner

## [0.206.1] - 2026-08-16

Release summary: 8 bug fixes.
Tag range: `v0.206.0..v0.206.1`.

### Bug Fixes

- **daemon**: preserve aggregate recall partials
- **daemon**: repair FTS mutation drift
- **daemon**: recover partial FTS loss
- **daemon**: recover lost FTS checkpoints
- **daemon**: cache FTS completeness
- **daemon**: bound partial FTS recall
- **daemon**: surface partial FTS recall
- **daemon**: bridge deferred FTS recall
...
Release summary: 6 bug fixes and 3 docs updates.
Tag range: `v0.205.9..v0.205.10`.

### Bug Fixes

- **daemon**: gate deferred startup callbacks
- **daemon**: serialize deferred owner work
- **daemon**: defer cold-start runtime work
- **daemon**: isolate startup scan environment
- **cli**: forward CPU profile options
- **cli**: repair native inspector handoff

### Docs

- **cli**: fix profiling cold start
- **cli**: make profiling launch linear
- **cli**: wait for inspector readiness

## [0.205.9] - 2026-08-16

Release summary: 4 bug fixes and 1 refactor.
Tag range: `v0.205.8..v0.205.9`.

### Bug Fixes

- **daemon**: preserve routed outage causes
- **daemon**: map recall outages to 503
- **daemon**: propagate reranker failures
- **daemon**: restore recall reranking

### Refactoring

- **daemon**: route recall through owner

## [0.205.8] - 2026-08-16

Release summary: 1 bug fix.
Tag range: `v0.205.7..v0.205.8`.

### Bug Fixes

- **secrets**: serialize migration reads

## [0.205.7] - 2026-08-16

Release summary: 1 bug fix.
Tag range: `v0.205.6..v0.205.7`.

### Bug Fixes

- **daemon**: await rehearsal boost

## [0.205.6] - 2026-08-16

Release summary: 1 bug fix.
Tag range: `v0.205.5..v0.205.6`.

### Bug Fixes

- **daemon**: order telemetry repair audit
...
Release summary: 8 bug fixes.
Tag range: `v0.205.3..v0.205.4`.

### Bug Fixes

- **daemon**: route exhaustion failure to owner
- **daemon**: route embedding work to owner
- **daemon**: preserve recall during cutover
- **daemon**: prevent embedding resurrection
- **daemon**: close embedding swap write race
- **daemon**: resume vector projection rebuild
- **daemon**: harden vector rebuild
- **daemon**: chunk embedding promotion

## [0.205.3] - 2026-08-16

Release summary: 1 bug fix.
Tag range: `v0.205.2..v0.205.3`.

### Bug Fixes

- **daemon**: route integrity through owner
...
Release summary: 8 bug fixes.
Tag range: `v0.204.3..v0.204.4`.

### Bug Fixes

- **daemon**: retry telemetry repair locks
- **daemon**: support Node sqlite repair
- **audit**: refresh recovery ledger
- **daemon**: preserve recovery pass precision
- **daemon**: close recovery race
- **daemon**: sequence orphan recovery
- **daemon**: close recovery audit gaps
- **daemon**: make recovery async

## [0.204.3] - 2026-08-15

Release summary: 1 bug fix.
Tag range: `v0.204.2..v0.204.3`.

### Bug Fixes

- **daemon**: resolve active embedding profile before backfill writes

## [0.204.2] - 2026-08-15

Release summary: 4 bug fixes.
Tag range: `v0.204.1..v0.204.2`.

### Bug Fixes

- **secrets**: make stale cleanup atomic
- **secrets**: await route deletions
- **secrets**: harden daemonless locking
- **secrets**: support daemonless CLI

## [0.204.1] - 2026-08-15

Release summary: 5 bug fixes and 1 refactor.
Tag range: `v0.204.0..v0.204.1`.

### Bug Fixes

- **daemon**: bound Discord heartbeat timer
- **daemon**: close recall async gaps
- **daemon**: await async recall slice work
- **audit**: refresh recall migration ledger
- **daemon**: await async db call chains

### Refactoring

- **daemon**: make recall routes async

## [0.204.0] - 2026-08-15

Release summary: 1 feature.
Tag range: `v0.203.10..v0.204.0`.

### Features

- **memorybench**: add dreaming parity profile

## [0.203.10] - 2026-08-15

Release summary: 8 bug fixes.
Tag range: `v0.203.9..v0.203.10`.

### Bug Fixes

- **search**: make vector reads atomic
- **daemon**: preserve recall during cutover
- **search**: keep vector recall generation aligned
- **daemon**: prevent embedding resurrection
- **daemon**: close embedding swap write race
- **daemon**: resume vector projection rebuild
- **daemon**: harden vector rebuild
...
Release summary: 1 bug fix.
Tag range: `v0.203.8..v0.203.9`.

### Bug Fixes

- **ci**: restore main quality gates

## [0.203.8] - 2026-08-15

Release summary: 7 bug fixes.
Tag range: `v0.203.7..v0.203.8`.

### Bug Fixes

- **audit**: refresh rebased migration ledger
- **daemon**: close source lifecycle races
- **daemon**: deduplicate migration notes
- **daemon**: drain async source telemetry
- **daemon**: refresh async migration ledger
- **daemon**: narrow async slice scope
- **daemon**: async pipeline maintenance

## [0.203.7] - 2026-08-15

Release summary: 5 bug fixes.
Tag range: `v0.203.6..v0.203.7`.

### Bug Fixes

- **audit**: refresh rebased telemetry ledger
- **telemetry**: close opt-out write race
- **audit**: refresh telemetry ledger
- **daemon**: gate telemetry startup backoff
- **daemon**: async telemetry writes

## [0.203.6] - 2026-08-15

Release summary: 3 bug fixes.
Tag range: `v0.203.5..v0.203.6`.

### Bug Fixes

- **audit**: refresh source event-loop ledger
- **daemon**: guard truncated source cleanup
- **daemon**: stream native source imports
...
Release summary: 3 bug fixes.
Tag range: `v0.203.3..v0.203.4`.

### Bug Fixes

- **daemon**: bound Darwin ps cleanup
- **daemon**: use ps for darwin ACPX ownership
- **daemon**: reap escaped ACPX children on darwin

## [0.203.3] - 2026-08-15

Release summary: 2 bug fixes.
Tag range: `v0.203.2..v0.203.3`.

### Bug Fixes

- **cli**: harden launchd migration
- **cli**: isolate launchd workspaces

## [0.203.2] - 2026-08-15

Release summary: 10 bug fixes.
Tag range: `v0.203.1..v0.203.2`.

### Bug Fixes

- **pi**: bound deferred session switches
- **lifecycle**: reset scheduled run outcomes
- **lifecycle**: preserve forced run outcomes
- **lifecycle**: resolve deferred shutdown work
- **pi**: preserve deferred session ordering
- **lifecycle**: bound provider and drain work
- **lifecycle**: align proof package with main
- **lifecycle**: fence abandoned synthesis writes
- **lifecycle**: emit owner proof observations
- **lifecycle**: align proof package version

## [0.203.1] - 2026-08-15

Release summary: 4 bug fixes.
Tag range: `v0.203.0..v0.203.1`.

### Bug Fixes

- **cli**: align browser opener types
- **cli**: bound browser opener cleanup
- **cli**: observe browser open failures
- **cli**: surface browser open failures
...
Tag range: `v0.202.2..v0.202.3`.

### Bug Fixes

- **release**: stage Kimi connector for npm

### Docs

- **harnesses**: align Kimi Code nav
- **harnesses**: add Kimi Code support

## [0.202.2] - 2026-08-15

Release summary: 2 bug fixes.
Tag range: `v0.202.1..v0.202.2`.

### Bug Fixes

- **daemon**: clear recovered source status
- **daemon**: back off source embeddings

## [0.202.1] - 2026-08-15

Release summary: 2 bug fixes.
Tag range: `v0.202.0..v0.202.1`.

### Bug Fixes

- **dreaming**: await rebased backlog regression
- **dreaming**: count full evidence backlog
...
Release summary: 3 bug fixes.
Tag range: `v0.201.1..v0.201.2`.

### Bug Fixes

- **cli**: hand off native inspector
- **cli**: proxy Bun inspector discovery
- **cli**: prevent inspector port collision
...
Release summary: 4 bug fixes.
Tag range: `v0.200.28..v0.200.29`.

### Bug Fixes

- **release**: authenticate desktop asset poll
- **release**: gate undraft on desktop assets
- **release**: let desktop own release undraft
- **release**: finalize desktop release after matrix
...
Release summary: 1 bug fix.
Tag range: `v0.200.26..v0.200.27`.

### Bug Fixes

- **quality**: enforce strict Biome rules
...
Release summary: 2 bug fixes.
Tag range: `v0.200.24..v0.200.25`.

### Bug Fixes

- **daemon**: harden macOS FD failures
- **daemon**: support macOS FD accounting

## [0.200.24] - 2026-08-14

Release summary: 1 bug fix.
Tag range: `v0.200.23..v0.200.24`.

### Bug Fixes

- **cli**: gate duplicate removal guidance

## [0.200.23] - 2026-08-14

Release summary: 2 bug fixes.
Tag range: `v0.200.22..v0.200.23`.

### Bug Fixes

- **desktop**: restore macOS tray click
- **docker**: materialize core native deps

## [0.200.22] - 2026-08-14

Release summary: 2 bug fixes.
Tag range: `v0.200.21..v0.200.22`.

### Bug Fixes

- **ci**: maintain Dreaming gate paths
- **ci**: cover Dreaming helper paths

## [0.200.21] - 2026-08-14

Release summary: 1 bug fix.
Tag range: `v0.200.20..v0.200.21`.

### Bug Fixes

- **tests**: isolate telemetry env in hermetic runs
...
Release summary: 2 bug fixes.
Tag range: `v0.200.18..v0.200.19`.

### Bug Fixes

- **core**: restore strict workspace reader
- **core**: restore workspace override precedence
...
Release summary: 2 bug fixes.
Tag range: `v0.200.15..v0.200.16`.

### Bug Fixes

- **daemon**: fail on filesystem budget truncation
- **daemon**: bound filesystem traversal
...
Release summary: 1 bug fix.
Tag range: `v0.200.13..v0.200.14`.

### Bug Fixes

- **cli**: stop detached daemon process groups

## [0.200.13] - 2026-08-13

Release summary: 1 bug fix.
Tag range: `v0.200.12..v0.200.13`.

### Bug Fixes

- **sources**: preflight macOS pickers

## [0.200.12] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.200.11..v0.200.12`.

### Bug Fixes

- **desktop**: resolve Windows Bun fallback
- **desktop**: handle bundled runtime ENOENT

## [0.200.11] - 2026-08-13

Release summary: 1 bug fix.
Tag range: `v0.200.10..v0.200.11`.

### Bug Fixes

- **desktop**: prevent duplicate app launches

## [0.200.10] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.200.9..v0.200.10`.

### Bug Fixes

- **release**: narrow retry predicate
- **release**: retry transient GitHub API failures

## [0.200.9] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.200.8..v0.200.9`.

### Bug Fixes

- **daemon**: validate semantic premises
- **daemon**: reject failed backlog snapshots

## [0.200.8] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.200.7..v0.200.8`.

### Bug Fixes

- **cli**: coalesce liveness probes
- **cli**: coalesce daemon startup probes

## [0.200.7] - 2026-08-13

Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `v0.200.6..v0.200.7`.
...
Release summary: 3 bug fixes.
Tag range: `v0.200.5..v0.200.6`.

### Bug Fixes

- **extension**: migrate localhost daemon URLs
- **network**: route client loopback resolution
- **network**: normalize loopback daemon URLs

## [0.200.5] - 2026-08-13

Release summary: 4 bug fixes.
Tag range: `v0.200.4..v0.200.5`.

### Bug Fixes

- **test**: isolate legacy OpenClaw env
- **test**: close hermetic env gaps
- **test**: close hermetic env gaps
- **test**: isolate hermetic test environment

## [0.200.4] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.200.3..v0.200.4`.

### Bug Fixes

- **macos**: resolve launchd child executables
- **macos**: preserve launchd executable paths

## [0.200.3] - 2026-08-13

Release summary: 3 bug fixes.
Tag range: `v0.200.2..v0.200.3`.

### Bug Fixes

- **sources**: classify discovery permission denials
- **sources**: cover Discord TCC cache reads
- **sources**: guide macOS permission denials

## [0.200.2] - 2026-08-13

Release summary: 1 bug fix.
Tag range: `v0.200.1..v0.200.2`.

### Bug Fixes

- **database**: avoid WAL on network volumes

## [0.200.1] - 2026-08-13

Release summary: 10 bug fixes.
Tag range: `v0.200.0..v0.200.1`.

### Bug Fixes

- **daemon**: close embedding ownership race
- **daemon**: close embedding repair races
- **daemon**: default repaired embedding scope
- **daemon**: preserve cross-agent embeddings
- **daemon**: scope orphan embedding repair
- **daemon**: scope embedding maintenance
- **daemon**: guard content migration races
- **daemon**: guard migration promotion races
- **daemon**: guard repair promotion races
- **daemon**: converge autonomous embedding repairs

## [0.200.0] - 2026-08-13

Release summary: 1 feature and 1 bug fix.
Tag range: `v0.199.32..v0.200.0`.

### Features

- **daemon**: expose workload diagnostics

### Bug Fixes

- **daemon**: correct workload diagnostics

## [0.199.32] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.199.31..v0.199.32`.

### Bug Fixes

- **daemon**: count telemetry log write drops
- **daemon**: bound telemetry JSONL
...
Release summary: 1 bug fix.
Tag range: `v0.199.29..v0.199.30`.

### Bug Fixes

- **daemon**: match startup status diagnostics

## [0.199.29] - 2026-08-13

Release summary: 2 bug fixes.
Tag range: `v0.199.28..v0.199.29`.

### Bug Fixes

- **daemon**: match windows exit status
- **daemon**: make signal regression portable
...
Release summary: 2 bug fixes.
Tag range: `v0.199.26..v0.199.27`.

### Bug Fixes

- **daemon**: handle signal startup exits
- **daemon**: capture startup stderr

## [0.199.26] - 2026-08-12

Release summary: 1 bug fix.
Tag range: `v0.199.25..v0.199.26`.

### Bug Fixes

- **ci**: skip Electron downloads in daemon builds

## [0.199.25] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.24..v0.199.25`.

### Bug Fixes

- **daemon**: hard-bound integrity scan
- **daemon**: defer startup integrity scan

## [0.199.24] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.23..v0.199.24`.

### Bug Fixes

- **dashboard**: reject error-shaped count responses
- **dashboard**: use live sidebar counts

## [0.199.23] - 2026-08-12

Release summary: 3 bug fixes.
Tag range: `v0.199.22..v0.199.23`.

### Bug Fixes

- **wrapper**: recover malformed connector markers
- **wrapper**: validate connector marker
- **wrapper**: warn on blocked asset install

## [0.199.22] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.21..v0.199.22`.

### Bug Fixes

- **inference**: bound Pi permit waits
- **inference**: bound Pi agent initialization

## [0.199.21] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.20..v0.199.21`.

### Bug Fixes

- **daemon**: bound stateless MCP requests
- **cli**: skip PATH writes in noninteractive installs
...
Release summary: 1 bug fix.
Tag range: `v0.199.18..v0.199.19`.

### Bug Fixes

- **daemon**: expose document ingest admission

## [0.199.18] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.17..v0.199.18`.

### Bug Fixes

- **daemon**: normalize vacuum space failures
- **daemon**: harden vacuum space checks

## [0.199.17] - 2026-08-12

Release summary: 4 bug fixes.
Tag range: `v0.199.16..v0.199.17`.

### Bug Fixes

- **cli**: bound PATH alias matching
- **cli**: match PATH entries exactly
- **cli**: preserve PATH startup precedence
- **cli**: persist native install PATH

## [0.199.16] - 2026-08-12

Release summary: 1 bug fix.
Tag range: `v0.199.15..v0.199.16`.

### Bug Fixes

- **desktop**: relax macOS signing gate

## [0.199.15] - 2026-08-12

Release summary: 1 bug fix.
Tag range: `v0.199.14..v0.199.15`.

### Bug Fixes

- **cli**: execute pyenv installer via shell

## [0.199.14] - 2026-08-12

Release summary: 1 bug fix.
Tag range: `v0.199.13..v0.199.14`.

### Bug Fixes

- **daemon**: retain one migration backup

## [0.199.13] - 2026-08-12

Release summary: 1 bug fix.
Tag range: `v0.199.12..v0.199.13`.

### Bug Fixes

- **daemon**: defer legacy vacuum conversion
...
Release summary: 2 bug fixes.
Tag range: `v0.199.10..v0.199.11`.

### Bug Fixes

- **desktop**: repair macOS signing workflow
- **desktop**: fail closed on macOS signing

## [0.199.10] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.9..v0.199.10`.

### Bug Fixes

- **secrets**: preserve legacy store keys
- **secrets**: persist stable machine identity

## [0.199.9] - 2026-08-12

Release summary: 2 bug fixes.
Tag range: `v0.199.8..v0.199.9`.

### Bug Fixes

- **daemon**: defer launchd update restart
- **daemon**: enforce Bun single-instance lock
