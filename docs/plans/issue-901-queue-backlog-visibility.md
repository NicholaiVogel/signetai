...
- [ ] `platform/core/src/migrations/088-job-cancellations.ts`: creates
...
- [ ] `platform/core/src/migrations/089-job-archive.ts`: creates
...
- [ ] `platform/daemon/src/migrations/migrations.test.ts` (existing) —
      exercise `088-job-cancellations` and `089-job-archive` up +
