...
[Pipeline V2](/pipeline/) is the autonomous memory processing subsystem. It runs
source ingestion, retention, summaries, and Dreaming under
`memory.pipelineV2` (see [Configuration](/configuration/)). A remember save is immediately
